...
def print_death_age(people_dict):
    ...
    for key, value in people_dict.items():
        ...
        age_at_death =  value[DEATH_YEAR_INDEX] - value[BIRTH_YEAR_INDEX]
        

        print(name, age_at_death)
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        husband_name = husband_value[NAME_INDEX]
        wife_name = wife_value[NAME_INDEX]
        husband_age_at_wedding = wedding - husband_value[BIRTH_YEAR_INDEX]
        wife_age_at_wedding = wedding - wife_value[BIRTH_YEAR_INDEX]
        print(f"{husband_name} {husband_age_at_wedding} > {wedding} < {wife_name} {wife_age_at_wedding} ")
